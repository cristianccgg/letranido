        ...
        <div className="p-6">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {socialNetworks.map((network) => (
                <button
                  key={network.name}
                  onClick={() => handleSocialShare(network.url)}
                  className={`${network.color} text-white px-4 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2`}
                >
                  {network.icon}
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            <p className="text-xs text-blue-700">
              💡 Al compartir en redes sociales, se abrirá una nueva pestaña. Si ya tienes sesión iniciada, el contenido se rellenará automáticamente.
            </p>
          </div>
        </div>
      </div>
