...
import { Cookie, Shield, Settings, Database, AlertTriangle, Check } from 'lucide-react';
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            para recordar información sobre tu visita y preferencias.
          </p>

          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 mb-2">¿Por qué usamos cookies?</h3>
            <p className="text-gray-700 text-sm">
              Las cookies nos permiten ofrecerte una experiencia personalizada, mantener tu sesión 
              activa, recordar tus preferencias, y analizar cómo mejoramos la plataforma.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="border rounded-lg p-6 mb-4">
            ...
            <p className="text-gray-600 mb-4">
              Necesarias para el funcionamiento básico de la plataforma. No puedes desactivarlas.
            </p>
          ...
          <div className="border rounded-lg p-6 mb-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold text-gray-900">📊 Cookies de Analytics</h3>
          ...
          <div className="border rounded-lg p-6 mb-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold text-gray-900">🎨 Cookies de Personalización</h3>
            ...
            <p className="text-gray-600 mb-4">
              Recuerdan tus preferencias de interfaz y configuraciones personalizadas.
            </p>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <ul className="text-red-800 space-y-2">
              <li>• <strong>Cookies de terceros:</strong> Google Analytics, Facebook Pixel, etc.</li>
              <li>• <strong>Cookies publicitarias:</strong> Para mostrar anuncios personalizados</li>
              <li>• <strong>Tracking cross-site:</strong> Seguimiento entre diferentes sitios web</li>
              <li>• <strong>Fingerprinting:</strong> Identificación única del dispositivo</li>
              <li>• <strong>Cookies de redes sociales:</strong> Botones de compartir con tracking</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-3">🎛️ En Letranido</h3>
              <ul className="text-blue-800 text-sm space-y-2">
                <li>• <strong>Banner inicial:</strong> Configura al registrarte</li>
                <li>• <strong>Menú de usuario:</strong> "Configurar Cookies"</li>
                <li>• <strong>Cambios inmediatos:</strong> Efecto instantáneo</li>
                <li>• <strong>Historial:</strong> Ve cuándo diste consentimiento</li>
              </ul>
            </div>

            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <h3 className="font-semibold text-gray-900 mb-3">🌐 En tu Navegador</h3>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
            <p className="text-yellow-800 text-sm">
              <strong>⚠️ Nota importante:</strong> Desactivar todas las cookies puede afectar 
              la funcionalidad de la plataforma. Las cookies esenciales son necesarias para 
              mantener tu sesión activa y garantizar la seguridad.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Derecho al Consentimiento</h3>
                <p className="text-gray-600 text-sm">
                  Puedes aceptar o rechazar cookies no esenciales en cualquier momento.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-gray-900">Derecho a la Información</h3>
                <p className="text-gray-600 text-sm">
                  Tienes acceso completo a información sobre qué cookies usamos y por qué.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-gray-900">Derecho de Revocación</h3>
                <p className="text-gray-600 text-sm">
                  Puedes cambiar tus preferencias de cookies en cualquier momento sin explicación.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Check className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-gray-900">Derecho a la Eliminación</h3>
                <p className="text-gray-600 text-sm">
                  Puedes eliminar cookies existentes desde tu navegador o desde tu cuenta.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-2">🇪🇺 GDPR (Europa)</h3>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <h3 className="font-semibold text-purple-900 mb-2">🇺🇸 CCPA (California)</h3>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <h3 className="font-semibold text-green-900 mb-2">🇧🇷 LGPD (Brasil)</h3>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 mb-2">Cuando actualicemos:</h3>
            <ul className="text-gray-700 text-sm space-y-1">
              <li>• Te notificaremos por email (si tienes notificaciones activadas)</li>
        ...
        <section className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <div className="text-blue-800 space-y-2">
              <p><strong>Email:</strong> info@letranido.com</p>
              <p><strong>Asunto sugerido:</strong> "Consulta sobre Cookies - [Tu pregunta]"</p>
              <p><strong>Tiempo de respuesta:</strong> 3-5 días hábiles</p>
        ...
        <div className="border-t border-gray-200 pt-8 mt-12">
          <div className="bg-primary-50 rounded-lg p-6 text-center">
            ...
            <p className="text-primary-700 text-sm mb-4">
              En Letranido, tu privacidad es nuestra prioridad. Tienes control completo 
              sobre cómo usamos las cookies en tu experiencia de escritura.
            </p>
