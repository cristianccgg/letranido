...
const AllStories = () => {
  ...
  const availableCategories = useMemo(() => {
    const categories = [
      ...new Set(stories.map((s) => s.story_category || s.contest_category)),
    ].filter(Boolean);
  ...
  const loadAllFinishedStories = async () => {
    try {
      ...
      if (allStories.length > 0) {
        console.log(
          "📚 AllStories - Historias antes de cargar usuarios:",
      ...
      if (allStories.length > 0) {
        const userIds = [
          ...new Set(allStories.map((story) => story.user_id)),
        ].filter(Boolean);
        ...
        if (userIds.length > 0) {
          try {
            ...
            console.log("🔍 Respuesta de user_profiles:", {
              userProfiles,
              userError,
            });
            ...
            if (userProfiles && userProfiles.length > 0) {
              ...
              console.log(
                "📚 AllStories - Historias después de cargar usuarios:",
                allStories.slice(0, 3).map((s) => ({
                  title: s.title,
                  author: s.author,
                  user_id: s.user_id,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-dark-300 text-lg mb-6">
            Explora todas las historias de nuestros retos de escritura. Descubre
            nuevos talentos y sumérgete en mundos creativos.
          </p>

          {/* Link al concurso actual */}
          <div className="hidden md:block bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-200 dark:border-indigo-700 rounded-lg p-4 sm:p-6 mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex-1">
                ...
                <p className="text-indigo-700 dark:text-indigo-300 text-sm">
                  Únete al reto actual y comparte tu creatividad
                </p>
              </div>
                    ...
                    <div className="p-4">
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html:
                            story.excerpt || "Sin vista previa disponible.",
                        }}
                      />
                            ...
                            <div className="flex flex-col  min-w-0">
                              <div className="flex items-center">
                                ...
                                <ProfileButton
                                  ...
                                  variant="primary"
                                  showText={false}
                                  className="flex-shrink-0 ml-2 h-fit"
                                />
                              </div>
                              <div>
