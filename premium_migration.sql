-- Migración Premium - Solo 2 planes: básico y premium (escritor pro)
-- Feedback profesional: incluido en premium, pay-per-use para básicos
-- Ejecutar en Supabase SQL Editor

-- 1. Agregar nuevas columnas para sistema premium
...
-- 2. Crear tipos de planes como ENUM (solo 2 planes reales)
DO $$ 
BEGIN 
...
-- 3. Actualizar columna plan_type para usar el enum
ALTER TABLE public.user_profiles 
ALTER COLUMN plan_type TYPE plan_types USING plan_type::plan_types;

-- 4. Migrar datos existentes - IMPORTANTE: mantener compatibilidad
...
-- 5. Función helper para verificar si plan está activo
...
-- 6. Función helper para obtener límites por plan
...
-- 8. Trigger para mantener is_pro sincronizado (compatibilidad)
...
-- Descomenta estas líneas si quieres crear usuarios de prueba
/*
INSERT INTO auth.users (id, email) 
VALUES ('00000000-0000-0000-0000-000000000001', 'premium_test@letranido.com')
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.user_profiles (id, display_name, plan_type, premium_features)
VALUES (
    '00000000-0000-0000-0000-000000000001', 
    'Usuario Premium Test',
    'premium',
    '{"beta_tester": true}'::jsonb
